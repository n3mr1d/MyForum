...
<span class="relative inline-flex items-center">
  ...
  <i class="fa-solid fa-circle text-green-500 relative"></i> Online
</span>';
$l['postbit_status_offline'] = '  <i class="fa-solid fa-circle text-gray-400"></i> Offline';
$l['postbit_online'] = '<span class=" mr-3 relative inline-flex items-center">
<span class="absolute inline-flex h-3 w-3 rounded-full bg-green-400 opacity-75 animate-ping"></span>
  <i class="fa-solid fa-circle text-green-500 relative"></i>
</span>';
$l['postbit_offline'] ='<i class="fa-solid mr-3  fa-circle text-gray-400"></i>'; 
...
$l['awaiting_message_link'] = ' <a class="font-medium text-blue-600! dark:text-blue-500 hover:underline!" href="{1}/{2}/index.php?module=user-awaiting_activation">Go to the ACP</a>.';
$l['awaiting_message_single'] = 'There is <b class="text-white font-semibold"> 1</b> account awaiting activation. Please go to your ACP to activate the user.';
$l['awaiting_message_plural'] = 'There are  <b class="font-semibold text-white">{1}</b> accounts awaiting activation. Please go to your ACP to activate the users.';
