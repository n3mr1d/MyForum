...
if ($mybb->input['action'] == "copy") {
	...
	$form_container->output_row($lang->icon_title, $lang->icon_desc, $form->generate_text_box('icon', $copy_data['icon'], array('id' => 'icon')), 'icon');
...
if ($mybb->input['action'] == "add") {
	...
	$form_container->output_row($lang->icon_title, $lang->icon_desc, $form->generate_text_box('icon', $mybb->input['icon'], array('id' => 'icon')), 'icon');
...
if ($mybb->input['action'] == "edit") {
	...
	$form_container->output_row($lang->parent_forum . " <em>*</em>", $lang->parent_forum_desc, $form->generate_forum_select('pid', $forum_data['pid'], array('id' => 'pid', 'main_option' => $lang->none)), 'pid');
	$form_container->output_row($lang->display_order, "", $form->generate_numeric_field('disporder', $forum_data['disporder'], array('id' => 'disporder', 'min' => 0)), 'disporder');
	$form_container->output_row($lang->icon_title, $lang->icon_desc, $form->generate_text_box('icon', $forum_data['icon'], array('id' => 'icon')), 'icon');
