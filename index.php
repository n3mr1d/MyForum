...
$templatelist = 'index,navbar,index_whosonline,index_whosonline_memberbit,forumbit_depth1_cat,forumbit_depth2_cat,forumbit_depth2_forum,forumbit_depth1_forum_lastpost,forumbit_depth2_forum_lastpost,forumbit_moderators';
...
$lang->load('index');
eval('$navbar = "'.$templates->get('navbar').'";');
...
if ($mybb->settings['showindexstats'] != 0) {
    ...
    $lang->stats_posts = $lang->sprintf($lang->stats_posts, my_number_format($stats['numposts']));
    $lang->stats_threads = $lang->sprintf($lang->stats_threads, my_number_format($stats['numthreads']));
